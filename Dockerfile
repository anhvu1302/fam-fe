...
# Nhận build args - Backend & Storage
ARG BACKEND_API_URL
ARG NEXT_PUBLIC_MINIO_URL

# Nhận build args - Security: Encryption & Replay Protection
ARG NEXT_PUBLIC_CRYPTO_KEY
ARG NEXT_PUBLIC_ENABLE_ENCRYPTION
ARG NEXT_PUBLIC_MAX_REQUEST_AGE

# Nhận build args - Security: Direct Access Protection
ARG NEXT_PUBLIC_APP_SIGNATURE_KEY
ARG ALLOWED_ORIGINS
...
ENV NEXT_PUBLIC_MAX_REQUEST_AGE=$NEXT_PUBLIC_MAX_REQUEST_AGE
ENV NEXT_PUBLIC_APP_SIGNATURE_KEY=$NEXT_PUBLIC_APP_SIGNATURE_KEY
